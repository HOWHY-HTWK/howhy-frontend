...
import QuestionEditor from "../edit/components/QuestionEditor"
...
export default function EditQuestions() {
    ...
    useEffect(() => {
        getVideoInfoFromMediaserver(videoId)
            .then((response) => {
    ...
    return (
        <div className={["centerVertical", styles.wrapper].join(" ")}>
            ...
            {editedQuestion ? (
                ...
                <>
                    <button
                        className={["button", styles.addButton].join(" ")}
                        onClick={addNewQuestion}
                    >
                        Neue Frage zum aktuellen Zeitpunk hinzufügen
                    </button>
                    <QuestionList
                        questions={questions}
