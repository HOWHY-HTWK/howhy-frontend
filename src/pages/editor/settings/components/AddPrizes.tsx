...
import { deletePrize, getMessage, getPrizes, postMessage, postPrize, updatePrize } from "../../../../utils/api/api"
    ...
    function getPrizeListItem(prize, key) {
        return (
            <div key={key}>
                <form
                    method="post"
                    className={["center", styles.listItem].join(" ")}
                    onSubmit={(e) => handleUpdate(e, prize.id)}
                >
                    <input
                        name="title"
                    ...
                    <button className={[styles.save].join(" ")} type="submit">
                        ✓
                    </button>
                </form>
            </div>
    ...
    return (
        <div className={["centerVertical"].join(" ")}>
            <div className={[styles.formwrapper].join(" ")}>
                ...
                >
                    ...
                    <div className={[styles.label].join(" ")}>
                        <div
                            className={[
                                prizeData.points == "" ? styles.hidden : null
                            ].join(" ")}
                        >
                            Punkte
                        </div>
            ...
            <div className={["centerVertical", styles.messageWrap].join(" ")}>
                ...
                />
                <div className={["button"].join(" ")} onClick={saveMessage}>
                    Nachricht Speichern
                </div>
            </div>
        </div>
