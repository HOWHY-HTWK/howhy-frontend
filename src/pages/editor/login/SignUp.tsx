...
export default function SignUp({ toggleSignUp, logIn }) {
    ...
    function getUserNameInfo() {
        return (
            ...
            >
                Es wird automatisch ein anonymer Benutzername generiert. Dieser
                kann allerdings wie gewünscht angepasst werden.
            </div>
        )
    }
        ...
        <div className={[styles.formwrapper].join(" ")}>
            ...
            >
                ...
                <div className={[styles.label].join(" ")}>
                    <div
                        className={[
                            signUpData.email == "" ? styles.hidden : null
                        ].join(" ")}
                    >
                        E-Mail
                    </div>
                ...
                <div className={[styles.label].join(" ")}>
                    <div
                        className={[
                            signUpData.password == "" ? styles.hidden : null
                        ].join(" ")}
                    >
                        Passwort
                    </div>
                ...
                <label className={[styles.requestRights].join(" ")}>
                    <input
                        ...
                        onChange={() =>
                            setsignUpData({
                                ...signUpData,
                                editorRights: !signUpData.editorRights
                            })
                        }
                        type="checkbox"
                    ></input>
                    Rechte zum Bearbeiten von Videos anfordern
                </label>
